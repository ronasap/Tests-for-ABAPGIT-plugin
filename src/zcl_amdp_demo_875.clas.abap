CLASS zcl_amdp_demo_875 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_amdp_demo_875 IMPLEMENTATION.
 ...
 BY DATABASE PROCEDURE
    ...
    USING
      /dmo/flight
      /dmo/carrier
      zcl_amdp_demo_875=>convert_currency.
    ...
    call "ZCL_AMDP_DEMO_875=>CONVERT_CURRENCY"( :flights, result );
